...
![30 Modulos of React banner](../images/30_Modulos_of_react_banner_Modulo_28.jpg)
...
1. Develop the following application, [twitter tweets](https://www.30Modulosofreact.com/Modulo-28/twitter-clone). The application has all the CRUD operations. 
