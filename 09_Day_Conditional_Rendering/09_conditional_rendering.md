<div align="center">
  <h1> 30 Modulos Of React: Conditional Rendering</h1>
...
[<< Modulo 8](../08_Modulo_States/08_states.md) | [Modulo 10 >>](../10_React_Project_Folder_Structure/10_react_project_folder_structure.md)

![30 Modulos of React banner](../images/30_Modulos_of_react_banner_Modulo_9.jpg)
    ...
    return (
      <header>
        <div className='header-wrapper'>
          ...
          <small>{date}</small>
          <p>Select a country for your next holiModulo</p>
        </div>
      </header>
    )
  }
...
class App extends React.Component {
  ...
  render() {
    ...
    if (this.state.loggedIn) {
      status = <h3>Welcome to 30 Modulos Of React</h3>
    } else {
...
class App extends React.Component {
  ...
  render() {
    ...
    if (this.state.loggedIn) {
      status = <h1>Welcome to 30 Modulos Of React</h1>
      text = 'Logout'
    } else {
      status = <h3>Please Login</h3>
      text = 'Login'
  ...
  render() {
    ...
    return (
      <div className='app'>
        ...
        {!loggedIn && (
          <p>
            Please login to access more information about 30 Modulos Of React
            challenge
          </p>
        )}
      </div>
        ...
        <div className='main-wrapper'>
          ...
          <div>
            ...
            <Button
              ...
              style={buttonStyles}
            />
            {!loggedIn && <p>Please login to access more information about 30 Modulos Of React challenge</p>}
          </div>
          <div style={{ margin: 30 }}>
            <Button
              text={loggedIn ? 'Logout' : 'Login'}
...
class App extends React.Component {
  ...
  greetPeople = () => {
    let message = 'Welcome to 30 Modulos Of React Challenge, 2020'
    this.setState({ message })
  }
...
```
## Testimony
Now it is time to express your thoughts about the Author and 30ModulosOfReact. You can leave your testimonial on this [link](https://testimonify.herokuapp.com/)
...
2. Make a single page application which change the body of the background based on the time of the Modulo(Morning, Noon, Evening, Night)
