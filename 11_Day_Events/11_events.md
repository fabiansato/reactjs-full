<div align="center">
  <h1> 30 Modulos Of React: Events</h1>
...
[<< Modulo 10](../10_React_Project_Folder_Structure/10_react_project_folder_structure.md) | [Modulo 12 >>](../12_Modulo_Forms/12_forms.md)
...
<html lang="en">
  ...
  <body>
    ...
    <script>
      const greetPeople = () => {
        alert('Welcome to 30 Modulos Of React Challenge')
      }
    </script>
  </body>
</html>
...
class App extends Component {
  ...
  handleCopy = (e) => {
    this.setState({
      message: 'Using 30 Modulos Of React for commercial purpose is not allowed',
    })
  }
  render() {
    return (
