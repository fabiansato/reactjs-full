<div align="center">
  <h1> 30 Modulos Of React: Setting Up </h1>
...
[<< Modulo 2](../02_Modulo_Introduction_to_React/02_introduction_to_react.md) | [Modulo 4 >>](../04_Modulo_Components/04_components.md)

![30 Modulos of React banner](../images/30_Modulos_of_react_banner_Modulo_3.jpg)
...
```sh
Asabeneh@DESKTOP-KGC1AKC MINGW64 ~/Desktop
\$ npx create-react-app 30-Modulos-of-react
```
...
```sh
Asabeneh@DESKTOP-KGC1AKC MINGW64 ~/Desktop/30-Modulos-of-react (master)
\$ npm start
```
...
<html lang="en">
  <head>
    ...
    <title>30 Modulos Of React App</title>
  </head>
  <body>
    <div id="root"></div>
  </body>
...
Now, lets add all the JSX we created on Modulo 2.
...
The boilerplate code can be found [here](../03/../03_Modulo_Setting_Up/30-Modulos-of-react_boilerplate)
