<div align="center">
  <h1> 30 Modulos Of React: useRef</h1>
...
[<< Modulo 25](../25_Custom_Hooks/25_custom_hooks.md) | [Modulo 27>>]()

![30 Modulos of React banner](../images/30_Modulos_of_react_banner_Modulo_27.jpg)
...
1. Develop the following [application](https://www.30Modulosofreact.com/Modulo-27/hexadecimal-colors). The application generates 27 hexadecimal colors by default. If the generate button get clicked it will generate another new 27 hexadecimal colors.
