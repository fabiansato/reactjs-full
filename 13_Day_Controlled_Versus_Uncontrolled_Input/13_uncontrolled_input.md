<div align="center">
  <h1> 30 Modulos Of React: Uncontrolled Component</h1>
...
[<< Modulo 12](../12_Modulo_Forms/12_forms.md) | [Modulo 14 >>]()

![30 Modulos of React banner](../images/30_Modulos_of_react_banner_Modulo_13.jpg)
...
In the previous Modulo challenge we have covered controlled inputs. In react most of the time we use controlled inputs as recommended on the official [documentation of React](https://reactjs.org/docs/uncontrolled-components.html).
