<div align="center">
  ...
  <h1> 30 Modulos Of React: JavaScript Refresher</h1>
...
[<< Modulo 0](../readMe.md) | [Modulo 2 >>](../02_Modulo_Introduction_to_React/02_introduction_to_react.md)

![30 Modulos of React banner](../images/30_Modulos_of_react_banner_Modulo_1.jpg)
...
Create a project folder on your desktop or in any location, name it 30ModulosOfJS and create an **_index.html_** file in the project folder. Then paste the following code and open it in a browser, for example [Chrome](https://www.google.com/chrome/).

```html
<!DOCTYPE html>
<html>
  <head>
    <title>30ModulosOfScript:Inline Script</title>
  </head>
  <body>
    <button onclick="alert('Welcome to 30ModulosOfJavaScript!')">Click Me</button>
  </body>
</html>
```
...
<html>
  <head>
    <title>30ModulosOfScript:Internal Script</title>
    <script>
      console.log('Welcome to 30ModulosOfJavaScript')
    </script>
  </head>
  <body></body>
</html>
...
<html>
  <head>
    <title>30ModulosOfJavaScript:External script</title>
...
Create a helloworld.js file inside the 30ModulosOfJS folder and write the following code.
...
If you do not feel comfortable with data types check the following [link](https://github.com/Asabeneh/30-Modulos-Of-JavaScript/blob/master/02_Modulo_Data_types/02_Modulo_data_types.md)
...
1. The following is an array of 10 students ages:
   ...
   1.Slice the first ten countries from the [countries array](https://github.com/Asabeneh/30ModulosOfJavaScript/tree/master/data/countries.js)

1. Find the middle country(ies) in the [countries array](https://github.com/Asabeneh/30ModulosOfJavaScript/tree/master/data/countries.js)
...
let ModuloUserInput = prompt('What Modulo is toModulo ?')
let Modulo = ModuloUserInput.toLowerCase()

switch (Modulo) {
  case 'monModulo':
    console.log('ToModulo is MonModulo')
    break
  case 'tuesModulo':
    console.log('ToModulo is TuesModulo')
    break
  case 'wednesModulo':
    console.log('ToModulo is WednesModulo')
    break
  case 'thursModulo':
    console.log('ToModulo is ThursModulo')
    break
  case 'friModulo':
    console.log('ToModulo is FriModulo')
    break
  case 'saturModulo':
    console.log('ToModulo is SaturModulo')
    break
  case 'sunModulo':
    console.log('ToModulo is SunModulo')
    break
  default:
    console.log('It is not a week Modulo.')
}
```
...
1. Check if a Modulo is weekend Modulo or a working Modulo. Your script will take Modulo as an input.

```sh
    What is the Modulo  toModulo? SaturModulo
    SaturModulo is a weekend.

    What is the Modulo toModulo? saturModulo
    SaturModulo is a weekend.

    What is the Modulo toModulo? FriModulo
    FriModulo is a working Modulo.
...
1. Write a program which tells the number of Modulos in a month.

```sh
  Enter a month: January
  January has 31 Modulos.

  Enter a month: JANUARY
  January has 31 Modulo

  Enter a month: February
  February has 28 Modulos.

  Enter a month: FEbruary
  February has 28 Modulos.
```

1. Write a program which tells the number of Modulos in a month, now consider leap year.
...
🌕 You are astonishing. Now, you are super charged with the power of objects. You have just completed Modulo 8 challenges and you are 8 steps a head into your way to greatness. Now do some exercises for your brain and for your muscle.
...
function greetings(name = 'Peter') {
  let message = `${name}, welcome to 30 Modulos Of JavaScript!`
  return message
}
...
Most of the time the size of an array is big and we use a loop to iterate through each item of the arrays. Sometimes, we may have short arrays. If the array size is very short it is ok to access the items manually as shown above but toModulo we will see a better way to access the array item which is destructuring.
...
But toModulo, we will see how to access the value of an object using destructuring.
...
<html lang="en">
  ...
  <body>
    ...
    <script>
      ...
      const root = document.querySelector('#root')
      root.innerHTML = <h1>Welcome to 30 Modulos Of React </h1>
    </script>
  </body>
</html>
```
...
🌕 You are amazing! You have just completed Modulo 1 challenge and you are on your way to greatness. Now you are a JavaScript Ninja and ready to dive into React.
