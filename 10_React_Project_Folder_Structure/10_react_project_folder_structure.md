<div align="center">
  <h1> 30 Modulos Of React: React Project Folder Structure</h1>
...
[<< Modulo 9](../09_Modulo_Conditional_Rendering/09_conditional_rendering.md) | [Modulo 11 >>](../11_Modulo_Events/11_events.md)

![30 Modulos of React banner](../images/30_Modulos_of_react_banner_Modulo_10.jpg)
...
const App = () => <h1>Welcome to 30 Modulos Of React</h1>
...
export const App = () => <h1>Welcome to 30 Modulos Of React</h1>
```
...
export function App () {
return <h1>Welcome to 30 Modulos Of React</h1>
}
```
...
export default const App = () => <h1>Welcome to 30 Modulos Of React</h1>
...
class App extends React.Component {
  render() {
    return <h1> 30 Modulos of React </h1>
  }
}
```
...
1. Make a simple portfolio using the components we have created so far. Implement a dark mode by using the function we wrote on Modulo 8 challenge.
