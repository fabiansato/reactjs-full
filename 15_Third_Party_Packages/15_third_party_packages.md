<div align="center">
  <h1> 30 Modulos Of React:Third Party Packages</h1>
...
[<< Modulo 14](../14_Modulo_Component_Life_Cycles/14_component_life_cycles.md) | [Modulo 16 >>](../16_Higher_Order_Component/16_higher_order_component.md)

![30 Modulos of React banner](../images/30_Modulos_of_react_banner_Modulo_15.jpg)
...
![NPM packages](../images/npm_package_Modulo_15.png)
...
```sh
Asabeneh@DESKTOP-KGC1AKC MINGW64 ~/Desktop/30-Modulos-of-react$ npm install node-sass
```

Using yarn:

```sh
Asabeneh@DESKTOP-KGC1AKC MINGW64 ~/Desktop/30-Modulos-of-react$ yarn add node-sass
```
...
```sh
Asabeneh@DESKTOP-KGC1AKC MINGW64 ~/Desktop/30-Modulos-of-react$ npm install axios
```

Using yarn:

```sh
Asabeneh@DESKTOP-KGC1AKC MINGW64 ~/Desktop/30-Modulos-of-react$ yarn add axios
```
...
```sh
Asabeneh@DESKTOP-KGC1AKC MINGW64 ~/Desktop/30-Modulos-of-react$ npm install react-icons
```

Using yarn:

```sh
Asabeneh@DESKTOP-KGC1AKC MINGW64 ~/Desktop/30-Modulos-of-react$ yarn add react-icons
```
  ...
  render() {
    return (
      <div className='App'>
        ...
        <p>ToModulo is {moment(new Date()).format('MMMM DD, YYYY HH:mm')}</p>
      </div>
    )
  }
}
  ...
  render() {
    return (
      <div className='App'>
        <Header>
          <div>
            <Title>30 Modulos Of React</Title>
            <h2>Getting Started React</h2>
            <h3>JavaScript Library</h3>
            <p>Instructor: Asabeneh Yetayeh</p>
            <small>Oct 15, 2020</small>
...
4. Use the validator package to validate the form you had in Modulo 12
...
[<< Modulo 14](../14_Modulo_Component_Life_Cycles/14_component_life_cycles.md) | [Modulo 16 >>]()
