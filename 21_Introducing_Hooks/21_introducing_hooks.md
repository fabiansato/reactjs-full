<div align="center">
  <h1> 30 Modulos Of React: Introducing React Hooks</h1>
...
[<< Modulo 20](../20_projects/20_projects.md) | [Modulo 22>>]()

![30 Modulos of React banner](../images/30_Modulos_of_react_banner_Modulo_21.jpg)
...
Using hooks we can access state without writing a class based component. Let's use the same example we used for class based components on Modulo 8.
